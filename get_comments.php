...
function get_comments($id_player_test)
{
    ...
    while ($row_biddingtest = mysqli_fetch_array($run_biddingtest)) {
        ...
        if ($_SESSION['id'] == 26 || $_SESSION['id'] == 27) {
            echo "
                                <small>
                ...
                <div class='modal-dialog modal-dialog-centered' role='document'>
                    ...
                    <form method='post' name='edit_comment" . $comment_id . "'>
                        <div class='modal-body'>
                            ...
                            <div class='mx-2'>
                            <div class='form-group'>
                                <textarea class='comments_text_area form-control' rows='3' name='comment" . $comment_id . "'>$comment</textarea>
                            </div>
                            </div>
                        </div>
                        <div class='modal-footer'>
